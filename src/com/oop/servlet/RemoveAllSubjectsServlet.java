...
/**
 * Servlet implementation class RemoveAllSubjectsServlet
 */
@WebServlet("/RemoveAllSubjectsServlet")
public class RemoveAllSubjectsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RemoveAllSubjectsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		iSubjectsServices.deleteAllSubjects();
